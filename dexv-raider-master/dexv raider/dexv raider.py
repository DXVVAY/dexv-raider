# Made by DEXV#6969 https://github.com/DXVVAY 
...
Do not do this without the permission of the person to whom the bruteforce attack is conducted.''')
    ...
    if choice == 12:
        print('''yoo yhis is dexv your dude made this shit cuz i was bored.
        im gonna make fuck ton of other things that can help with token grabbing and making money lmao.
        add me in discord if you wanna help me.
        ''')
